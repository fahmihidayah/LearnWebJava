 ...
 */
package com.fahmi.learn.java.controllers;

import com.fahmi.learn.java.models.Mahasiswa;
...
public class MahasiswaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            mahasiswa.setUmur(request.getParameter("umur"));
            
            request.setAttribute("mahasiswa", mahasiswa);
            RequestDispatcher view = request.getRequestDispatcher("/mahasiswa/mahasiswa_detail.jsp");
